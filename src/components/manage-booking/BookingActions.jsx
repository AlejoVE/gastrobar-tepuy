...
export const BookingActions = ({ booking, t, showConfirm, setShowConfirm, isProcessing, executeCancel }) => {
    console.log({ t })
    ...
    if (showConfirm) {
        return (
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="bg-red-50 p-5 rounded-xl border border-red-100">
    ...
    return (
        <div className="flex flex-col sm:flex-row gap-3">
            <button onClick={() => alert("Modificar flujo...")} className="flex-1 bg-charcoal text-white py-3 rounded-lg font-medium hover:bg-opacity-90 transition">
