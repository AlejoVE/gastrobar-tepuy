...
export const ErrorState = ({ t }) => (
    <div className="min-h-[70vh] flex items-center justify-center p-6">
        <div className="bg-white p-8 rounded-xl shadow-lg max-w-md w-full text-center border-t-4 border-red-500">
            ...
            <Link href="/" className="w-full bg-forest-green text-white py-2.5 rounded-lg font-medium hover:opacity-90">
...
export const CancelledState = ({ t }) => (
    <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="text-center py-6">
        ...
        <Link href="/" className="bg-charcoal text-white px-8 py-3 rounded-lg font-medium hover:bg-opacity-90 transition">
            {t("manage_booking.back_home")}
        </Link>
    </motion.div>
)